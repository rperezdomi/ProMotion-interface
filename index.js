...
io.on('connection', (socket) => {
    ...
    // Connect IMU 
    socket.on('ProMotion:connect_imu1', function(callbackFn) {
    ...
    socket.on('ProMotion:download', function(callbackFn) {
	...
	workbook.xlsx.writeFile('ProMotion.xlsx');
        

    });
    
    // calibrate Capture Motion sensor.
    socket.on('ProMotion:calibrate', function(callbackFn) {
